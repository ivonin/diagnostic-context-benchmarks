...
{
    private IDiagnosticContextFactory _diagnosticContextFactory;

    public DiagnosticContextBenchmarks()
    {
        _diagnosticContextFactory = new PrometheusDiagnosticContextFactory(
